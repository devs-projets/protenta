...
const InitialConfig = () => {
  ...
  useEffect(() => {
    ...
    const pol = {
      PolStartTime: floraison.start,
      PolEndTime: floraison.end,
      Periode: floraison.pollinisation,
      MomentFloraison: floraison.floraison,
    };
    const actionnaireStates = actionnairesList.reduce((acc, actionnaire) => {
